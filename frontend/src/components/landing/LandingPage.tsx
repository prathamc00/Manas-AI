  ...
  return (
    <div className="min-h-screen w-full overflow-y-auto bg-[#12110E] text-[#ECE7DF] flex flex-col selection:bg-[#D97757]/30 selection:text-white font-sans">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <button
              ...
              className="text-xs font-semibold text-white bg-[#D97757] hover:bg-[#C86646] px-4 py-1.5 rounded-xl transition shadow-md shadow-[#D97757]/15 active:scale-95 flex items-center space-x-1.5"
            >
      ...
      <section className="relative px-4 sm:px-6 pt-16 pb-20 md:pt-24 md:pb-28 max-w-6xl mx-auto text-center space-y-8 overflow-hidden">
        {/* Glow backdrop */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[350px] bg-[#D97757]/10 blur-[130px] rounded-full pointer-events-none -z-10" />

        {/* Badge */}
        <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-[#1F1E19] border border-[#33312B] text-[#D97757] text-xs font-medium animate-fade-in shadow-inner">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          <button
            onClick={onGetStarted}
            className="w-full sm:w-auto px-7 py-3 rounded-xl bg-[#D97757] hover:bg-[#C86646] text-white font-semibold text-sm transition shadow-lg shadow-[#D97757]/20 flex items-center justify-center space-x-2 active:scale-98"
          >
          ...
          <button
            onClick={onExploreGuest}
            className="w-full sm:w-auto px-6 py-3 rounded-xl bg-[#1A1915] hover:bg-[#22211C] text-[#ECE7DF] border border-[#2B2A24] text-sm font-medium transition active:scale-98"
          >
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 pt-4 text-xs text-[#736E65]">
        ...
        {/* Hero Preview Card */}
        <div className="mt-12 max-w-3xl mx-auto bg-[#181714] border border-[#2B2A24] rounded-2xl p-5 sm:p-7 shadow-2xl text-left space-y-4">
          ...
          <div className="space-y-3 text-xs sm:text-sm">
            <div className="p-3 rounded-xl bg-[#22211C]/60 border border-[#2E2C26] text-[#ECE7DF] max-w-[85%]">
            ...
            <div className="p-4 rounded-xl bg-[#1D1C17] border border-[#33312B] text-[#ECE7DF] space-y-2.5">
              <div className="flex items-center space-x-2 text-[#D97757] text-[11px] font-semibold">
                <Sparkles className="w-3.5 h-3.5" />
                <span>What I'm Hearing</span>
              </div>
              <div className="flex flex-wrap gap-1.5">
                <span className="text-[10px] px-2 py-0.5 rounded-md bg-[#D97757]/15 text-[#D97757] border border-[#D97757]/30">
                  Catastrophizing & All-or-Nothing
                </span>
                <span className="text-[10px] px-2 py-0.5 rounded-md bg-amber-500/15 text-amber-300 border border-amber-500/30">
                  High Self-Critique
                </span>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="p-6 rounded-2xl bg-[#1A1915] border border-[#262520] hover:border-[#38362E] transition duration-200 flex flex-col justify-between space-y-4 group hover:shadow-xl"
                >
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="w-10 h-10 rounded-xl bg-[#22211C] flex items-center justify-center text-[#D97757] border border-[#2E2C26] group-hover:scale-105 transition">
                    ...
                    <h3 className="font-editorial text-lg font-semibold text-[#ECE7DF]">{item.title}</h3>
      ...
      <section className="px-4 sm:px-6 py-20 max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((s, idx) => (
            <div key={idx} className="p-6 rounded-2xl bg-[#181714] border border-[#262520] space-y-3 relative">
      ...
      <section className="px-4 sm:px-6 py-16 bg-gradient-to-b from-[#181714] to-[#12110E] border-t border-[#22211C]">
        <div className="max-w-4xl mx-auto text-center p-8 sm:p-12 rounded-3xl bg-[#1D1C18] border border-[#33312B] shadow-2xl space-y-6">
          <h2 className="font-editorial text-3xl sm:text-4xl font-semibold text-[#ECE7DF]">
