...
import { Wind, Play, Pause, RotateCcw, Check, Eye } from 'lucide-react';
  ...
  return (
    <div className="flex-1 overflow-y-auto p-8 bg-[#181714] text-[#ECE7DF] animate-fade-in">
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        {/* Box Breathing Card */}
        <div className="p-8 rounded-2xl bg-[#22211C] border border-[#33312B] flex flex-col items-center justify-center space-y-6 shadow-sm">
          ...
          <div className="relative w-44 h-44 flex items-center justify-center my-3">
            <div
              className={`w-32 h-32 rounded-full bg-gradient-to-tr from-[#D97757]/30 to-[#E07A5F]/20 border border-[#D97757]/60 flex items-center justify-center transition-all duration-1000 ${
                isBreathingActive ? 'animate-breathe-warm' : 'scale-90 opacity-70'
              }`}
            >
              <div className="text-center">
                <span className="font-editorial text-4xl font-bold text-[#ECE7DF]">{countdown}</span>
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="px-6 py-2.5 rounded-xl bg-[#D97757] hover:bg-[#E38769] text-[#181714] text-xs font-semibold shadow-md transition duration-200 flex items-center space-x-2"
            >
              {isBreathingActive ? (
                <>
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-[#1D1C18] hover:bg-[#2B2A24] border border-[#33312B] text-[#A39D93] hover:text-[#ECE7DF] transition"
              title="Reset"
            >
        ...
        <div className="p-6 rounded-2xl bg-[#22211C] border border-[#33312B] space-y-3 shadow-sm">
            ...
            {sensoryItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-3.5 rounded-xl border transition duration-150 flex items-center space-x-3 ${
                    isDone
